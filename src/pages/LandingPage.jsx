export default function LandingPage() {
  return (
    <div className="text-gray-800">
      ...
      <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-md shadow-sm z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <ul className="hidden md:flex gap-8 text-sm font-medium">
            <li><a href="#home" className="hover:text-violet-600">Home</a></li>
            <li><a href="#about" className="hover:text-violet-600">About</a></li>
            <li><a href="#contact" className="hover:text-violet-600">Contact</a></li>
      ...
      {/* ================= HERO ================= */}
      <section id="home" className="min-h-screen flex items-center justify-center bg-[#fafafa] pt-20">
        <div className="max-w-4xl text-center px-6">
          ...
          <p className="text-gray-600 max-w-xl mx-auto mb-10">
            StrapHouse lets you customize premium watch straps or choose
            from our signature designs — perfectly crafted for every watch.
          </p>

          <button className="bg-gray-900 text-white px-8 py-4 rounded-full shadow-lg hover:scale-105 transition">
            Get Started
          </button>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              just an accessory — it’s a statement.  
              We combine premium materials, modern aesthetics, and complete
              personalization so your watch feels truly yours.
            </p>
          </div>
      ...
      {/* ================= FOOTER ================= */}
      <footer id="contact" className="py-10 bg-gray-900 text-gray-300 text-center text-sm">
